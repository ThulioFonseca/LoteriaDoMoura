...
public class ScreenObj extends JFrame {
	...
	private boolean StatusCount(Boolean[] stts) { // Verifica se no máximo 7 numeros foram removidos;
	...
	public JPanel CardNumber() { // Cria um "Cart�o" onde o usuario escolhe os 7 numeros que ser�o removidos das
									// apostas;
		
		JPanel panel = new JPanel();
		TitledBorder borda = new TitledBorder("Exclua 7 números");
		...
		JButton Excluir = new JButton("Excluir"); // Bot�o que adiciona os numeros selecionados � lista de excluidos -
													// "ToRemove"
		Excluir.setFocusable(false);
		Excluir.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				
				TitledBorder borda2 = new TitledBorder("Exclua 7 números");
		...
		JButton Reset = new JButton("Reset"); // Bot�o para limpar todos as variavies e iniciar um nova sele��o "limpa";
	...
	public JPanel Results(List<Integer> aposta, int bet) { // Metodo que retorna o cart�o com os numeros de cada aposta;
